...
const wrapSettingsForm = getFormSettings => SettingsForm => {
	...
	const connectComponent = connect(
		state => {
			...
			const stats = getStats( state, siteId );	// TODO: Should use settings endpoint?
			const isRequesting = isRequestingSettings( state, siteId ) && ! settings;

			return {
				isRequesting,
				settings: Object.assign( {}, settings, stats ),
				siteId,
				stats,
			};
		},
		...
		// wp_cache_pages
		// :
		// {search: false, feed: false, category: false, home: false, frontpage: false, tag: false,…}
