...
export const receiveUserSettings = ( { dispatch }, action, next, data ) => {
...
export const receiveSavedUserSettings = ( { dispatch }, { settingsOverride }, next, data ) => {
	dispatch( updateUserSettings( fromApi( data ) ) );
...
export default {
	[ USER_SETTINGS_REQUEST ]: [ dispatchRequest( requestUserSettings, receiveUserSettings, noop ) ],
	[ USER_SETTINGS_SAVE ]: [ dispatchRequest( saveUserSettings, receiveSavedUserSettings, noop ) ],
};
